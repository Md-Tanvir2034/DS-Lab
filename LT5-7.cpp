...
int main() {
    ...
    cout << "=============================================" << endl;
    cout << "This program implements a queue (FIFO) with a maximum size of " << MAXSIZE << "." << endl;
    cout << "Elements are added at the rear and removed from the front." << endl << endl;
    
    do {
        cout << "MAIN MENU:" << endl;
        cout << "1. Enqueue an element (Add to rear)" << endl;
        cout << "2. Dequeue an element (Remove from front)" << endl;
        ...
        switch (option) {
            ...
            case 4:
                value = queueSize();
                cout << "\tCurrent number of elements in the queue: " << value << "/" << MAXSIZE << endl;
                break;
            case 5:
                value = frontElement();
                if (value != -1)
